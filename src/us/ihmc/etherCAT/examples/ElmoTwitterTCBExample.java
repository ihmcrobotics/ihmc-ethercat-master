...
{
   private final ElmoTwitterLLACarrierBoard carrier = new ElmoTwitterLLACarrierBoard(22, 0);

   public ElmoTwitterTCBExample() throws IOException
   {
      super("em1", new PriorityParameters(PriorityParameters.getMaximumPriority()), new MonotonicTime(0, 1000000), true, 100000);
