...
public abstract class EtherCATRealtimeThread
{
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#setEtherCATStatusCallback(us.ihmc.etherCATMaster.wrapper.EtherCATStatusCallback)
    */
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#enableTrace()
    */
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#registerSDO(us.ihmc.etherCATMaster.wrapper.SDO)
    */
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#registerSlave(us.ihmc.etherCATMaster.wrapper.Slave)
    */
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#getJitterEstimate()
    */
   ...
   /**
    * @see us.ihmc.etherCATMaster.wrapper.Master#setMaximumExecutionJitter(long)
    */
